      ...
      <div className="bg-white shadow-header">
        ...
        <div className="max-w-[1280px] mx-auto px-6 h-16 flex items-center gap-6">
          ...
          <Link href="/" className="shrink-0 flex items-center gap-2 group">
            <div className="w-9 h-9 bg-orange-500 rounded-md flex items-center justify-center shadow-sm">
              <span className="text-white font-black text-lg leading-none">S</span>
            </div>
            <div className="flex flex-col leading-tight">
              <span className="text-[18px] font-black text-text-primary tracking-tight group-hover:text-orange-500 transition-colors">
                saganet
              </span>
