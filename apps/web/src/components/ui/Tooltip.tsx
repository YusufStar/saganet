    ...
    >
      ...
      <div
        ...
        className={[
          ...
          'bg-neutral-900 text-white text-[11px] font-medium rounded-sm',
          'shadow-modal',
      ...
      >
        ...
        <span
          className={[
            ...
            position === 'top'
              ? 'top-full border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-neutral-900'
              : 'bottom-full border-l-4 border-r-4 border-b-4 border-l-transparent border-r-transparent border-b-neutral-900',
          ].join(' ')}
        />
      </div>
    </div>
