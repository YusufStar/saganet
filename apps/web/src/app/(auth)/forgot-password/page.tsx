...
export default function ForgotPasswordPage() {
  ...
  if (sentTo) {
    return (
      <div className="text-center py-4">
        ...
        <h2 className="text-xl font-bold text-(--color-text-primary) mb-2">Check your inbox</h2>
        <p className="text-sm text-(--color-text-secondary) mb-1">We sent a reset link to</p>
        <p className="text-sm font-semibold text-(--color-text-primary) mb-6">{sentTo}</p>
        ...
        <Link href="/login" className="text-sm text-(--color-text-secondary) hover:text-orange-500 transition-colors">
          ← Back to Sign In
        </Link>
      </div>
    );
  ...
  return (
    <>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-(--color-text-primary)">Forgot password?</h1>
      ...
      <p className="mt-6 text-center text-sm">
        <Link href="/login" className="text-(--color-text-secondary) hover:text-orange-500 transition-colors">
          ← Back to Sign In
        </Link>
      </p>
    </>
