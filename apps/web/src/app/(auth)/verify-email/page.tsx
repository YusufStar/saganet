...
export default function VerifyEmailPage() {
  ...
  if (status === 'success') {
    return (
      <div className="text-center py-4">
        ...
        <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-2">Email verified!</h2>
  ...
  return (
    <div className="text-center py-4">
      ...
      <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-2">Verification failed</h2>
      <p className="text-sm text-[var(--color-text-secondary)] mb-6">{message}</p>
