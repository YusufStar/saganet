    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08)">
        ...
        <tr><td style="padding:40px">
          <h2 style="margin:0 0 16px;color:#18181b;font-size:20px">Welcome aboard! 🎉</h2>
          <p style="margin:0 0 12px;color:#52525b;line-height:1.6">
            Your account has been created with <strong style="color:#18181b">${data.email}</strong>.
          </p>
          <p style="margin:0 0 24px;color:#52525b;line-height:1.6">
            Please verify your email address to activate your account. A verification email has been sent separately.
          </p>
