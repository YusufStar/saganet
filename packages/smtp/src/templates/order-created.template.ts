...
export function orderCreatedTemplate(data: OrderCreatedTemplateData): { subject: string; html: string } {
  return {
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08)">
        ...
        <tr><td style="padding:40px">
          <h2 style="margin:0 0 16px;color:#18181b;font-size:20px">Order Confirmed</h2>
          <p style="margin:0 0 12px;color:#52525b;line-height:1.6">
            Hi <strong style="color:#18181b">${data.email}</strong>,
          </p>
          <p style="margin:0 0 12px;color:#52525b;line-height:1.6">
            Your order <strong style="color:#18181b">#${data.orderId}</strong> has been confirmed.
          </p>
          <table cellpadding="0" cellspacing="0" style="margin:24px 0;width:100%;border:1px solid #e4e4e7;border-radius:6px;overflow:hidden">
            ...
            <tr>
              <td style="padding:12px 16px;font-weight:600;color:#18181b;font-size:14px;border-top:1px solid #e4e4e7">Total</td>
              <td style="padding:12px 16px;color:#18181b;font-size:14px;font-weight:600;text-align:right;border-top:1px solid #e4e4e7">${data.totalAmount.toFixed(2)} ${data.currency}</td>
            </tr>
          </table>
